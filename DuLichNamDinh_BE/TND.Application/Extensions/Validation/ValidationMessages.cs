namespace TND.Application.Extensions.Validation
{
    public static class ValidationMessages
    {
        ...
        public const string PasswordIsWeak ="'{PropertyName}' must be a strong password containing at least one lowercase letter, one uppercase letter, one digit," +
            " one special character, and have a minimum length of 8 characters.";
        public const string NotAnImageFile ="'{PropertyName}' should be an image of type jpg, jpeg, or png.";
